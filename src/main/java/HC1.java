...
import com.succinctllc.hazelcast.lambdaj.accessor.CollectionAccessor;
import com.succinctllc.hazelcast.lambdaj.accessor.ObjectAccessor;
...
public class HC1 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // System.out.println(HazelcastLambdaj.sum(new MyCollectionProvider(),
        // o));

        int i = 0;
        for (BigDecimal b : HazelcastLambdaj.collect(
                new MyCollectionProvider(), o)) {
            System.out.println(++i + ": " + b);
        }

    }

    public static class MyProvider extends ObjectAccessor<Person> {
    ...
    public static class MyCollectionProvider extends CollectionAccessor<Person> {
